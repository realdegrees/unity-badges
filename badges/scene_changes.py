...
class SceneChangesBadge(Badge):
    ...
    def create(self, owner: str, repo: str, args: dict) -> Image:
        ...
        return draw_badge(label, content if len(content) > 1 else [], max_col_width=1200, padding=15, footer_color=footer_color, header_color=header_color, body_color="#555555")
